                                        ...
                                        children: [
                                          ...
                                          Column(
                                            ...
                                            children: [
                                              ...
                                              // Text('Jhon Doe | 12345678'.toTitleCase() , style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromRGBO(12, 68, 49, 1),fontFamily: 'Roboto'),),
                                              SizedBox(
                                                width: 0,
                                                height: 4,
                                              ),
                                              ...
                                              Text(
                                                  ...
                                                  style: TextStyle(
                                                      ...
                                                      color: Color.fromRGBO(
                                                          12, 68, 49, 1),
                                                      fontFamily: 'Roboto')),
                                              // Text('${this.preferences?.getString("nama_kantor")} |  003'.toTitleCase(), style: TextStyle(fontWeight: FontWeight.bold, color: Color.fromRGBO(12, 68, 49, 1),fontFamily: 'Roboto')),
                                              SizedBox(
                                                width: 0,
                                                height: 3,
                                              ),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    //     color: Color.fromRGBO(12, 68, 49, 1))
                                  ],
                                ),
                              ),
                              SizedBox(
